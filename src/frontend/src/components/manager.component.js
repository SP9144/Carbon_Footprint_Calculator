...
handleClick(e){
  ...
  window.location= '/register'
    ...
    <div className="mt-4 container my-0">
        ...
        <a style={{fontSize:"large"}} class=" nav-link text-success font-weight-bolder" href="/manager">MANAGER</a>
        <button class="navbar-toggler " type="button" data-toggle="collapse" data-target=".dual-collapse2">
            <span class="navbar-toggler-icon"></span>
        </button>

        <a style={{color:"white"}} class="btn btn-outline-dark navbar-brand mx-0 ml-4 px-2 py-2  button  font-weight-bolder  pt-2 font-weight-bold" href="/manager/uploaddatachoose">CFP Calculation</a>
        <button class="navbar-toggler " type="button" data-toggle="collapse" data-target=".dual-collapse2">
            <span class="navbar-toggler-icon"></span>
        </button>
        <a style={{color:"white"}} class="btn btn-outline-dark navbar-brand mx-3 px-2 py-2 button font-weight-bolder pt-2 font-weight-bold" href="/manager/analysis">Log Book</a>
        <button class="navbar-toggler " type="button" data-toggle="collapse" data-target=".dual-collapse2">
            <span class="navbar-toggler-icon"></span>
        </button>
        </div>
{/*
    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
        ...
        <ul class="navbar-nav ml-auto ">
            <li class="nav-item ">
             <a class="btn bg-danger my-1 nav-link text-light  font-weight-bolder"  onClick={this.handleClick}><h6 class="font-weight-bold">Logout</h6></a>
            </li>
            </ul>
    </div>
        </nav>
