...
import ManagerChoosebetweenTwoMap from './managerchoosebetweentwomap.component'
  ...
  // }
    ...
    render() {
      return(
        ...
        <form class="pt-2 mt-3 md-2" onSubmit={this.onSubmit}>
            <div className="form-group">
                <label style={{color: " rgba(0, 128, 248, 0.897)",fontSize: "large", fontWeight: "800"}}>Number Of Trucks: </label>
    ...
    <div>
      {this.state.Getpathsvariable ?<ManagerChoosebetweenTwoMap Ppath1= {this.state.path1} carbonfootprint1={this.state.carbonfootprint1} Ppath2={this.state.path2} carbonfootprint2={this.state.carbonfootprint2} source_location={this.state.source_location} destination_location={this.state.destination_location} no_of_vehicles={this.state.no_of_vehicles}></ManagerChoosebetweenTwoMap>:null}
    </div>


    <Route path="/manager/choosebetweentwomap" exact component={ManagerChoosebetweenTwoMap}/>
    </Router>
