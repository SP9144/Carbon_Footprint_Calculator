    ...
    render() {
      return(
        <div>
            ...
            <p style={{fontSize:"x-large"}} class="text-primary font-weight-bold">In Blue:<span style={{fontSize:"x-large"}} class=" text-light font-weight-bold"> CFP for Path With Shortest Distance :</span><span style={{fontSize:"x-large"}} class="text-primary font-weight-bold"> {this.props.carbonfootprint1}</span>  </p>
            <p style={{fontSize:"x-large"}} class="text-danger font-weight-bold">In Red:<span style={{fontSize:"x-large"}} class=" text-light font-weight-bold"> CFP for Path With Least Carbon Footprint : </span><span style={{fontSize:"x-large"}} class="text-danger font-weight-bold"> {this.props.carbonfootprint2}</span> </p>
            ...
            <button onClick={(e) => this.OnChangeredirect(e)} class="mt-2 btn bg-success text-light">View Paths on Map</button>
             ...
             {this.state.error}
             <br></br>
             <button type="submit" className="mt-2 btn btn-primary" onClick={this.submit}>Upload</button>
             </div>
        </div>
    )
    }
