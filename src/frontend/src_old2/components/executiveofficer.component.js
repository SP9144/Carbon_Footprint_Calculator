                ...
                <div className="container my-0">
                    <nav className="navbar navbar-expand-lg navbar-light bg-dark">
                      ...
                      <div className="collapse navbar-collapse">
                        ...
                        <a class="nav-link text-danger font-weight-bolder" href="/executiveofficer"><h6 class=" pt-3 font-weight-bold">Executive Officer</h6></a>
                        </li>
                        <li className="navbar-item">
                            <Link to="/executive/uploaddata" className=" navbar-brand mx-0 px-1 py-1  button  font-weight-bolder  text-success pt-2 font-weight-bold nav-link">Upload Data</Link>
                        </li>
                        <li className="navbar-item">
                            <Link to="/executive/visualize" className=" navbar-brand mx-0 px-1 py-1  button  font-weight-bolder  text-primary pt-2 font-weight-bold  nav-link">Visualize</Link>
                        </li>
                        </ul>
                      </div>
