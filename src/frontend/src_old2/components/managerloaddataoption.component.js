    ...
    render() {
      return(
       ...
       {/* <nav className="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class=" button btn-lg  px-2 py-2 text-light text-decoration-none font-weight-normal" style={{background:"rgb(148,20,128)", fontSize:"medium"}} href="/manager/uploaddatachoose/uploaddatamanual">Add Nodes Manually</a>
        <button class="navbar-toggler " data-toggle="collapse" type="button" data-toggle="collapse">
            <span class=""></span>
        </button>
        <a class="button btn-lg bg-warning  px-2 py-2 text-dark text-decoration-none  font-weight-normal" style={{fontSize:"medium"}} href="/manager/uploaddatachoose/uploaddatamap">Add Nodes on Map</a>
        <button class="navbar-toggler " data-toggle="collapse" type="button" data-toggle="collapse">
